# This script will load nix-built docker images of cardano-rest applications
...
#
# 1. The repo (default "inputoutput/cardano-explorer-api") is changed to match
